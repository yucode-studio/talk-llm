...
public:
    ...
    /// </summary>
    /// <param name="style">The speaking style.</param>
    void SetStyle(const SPXSTRING& style) {
        SetProperty(PropertyId::SpeechSynthesisRequest_Style, style);
    }

    /// <summary>
    /// Set the speaking temperature.
    /// </summary>
    /// <param name="temperature">The speaking temperature.</param>
    void SetTemperature(const float temperature) {
        SetProperty(PropertyId::SpeechSynthesisRequest_Temperature, std::to_string(temperature));
    }
